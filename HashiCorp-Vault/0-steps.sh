...
sudo certbot certonly --manual --preferred-challenges=dns --key-type rsa \
    --email bobboss005@gmail.com --server https://acme-v02.api.letsencrypt.org/directory \
    --agree-tos -d *.gehana26.fun

# Certificate is saved at: /etc/letsencrypt/live/gehana26.fun/fullchain.pem
# Key is saved at:         /etc/letsencrypt/live/gehana26.fun/privkey.pem
...
8
export VAULT_ADDR=https://kmsvault.gehana26.fun:8200
echo "export VAULT_ADDR=https://kmsvault.gehana26.fun:8200" >>~/.bashrc
